...
7) Avoid inline code for plain text
...
8) Include testing and deployment notes
...
## Summary
- Add overview page and wire it to backend endpoints

## Why
- Surface featured repos and active job on the dashboard
...
## Risks / Rollback
- Low risk; rollback by reverting the page and routes.
