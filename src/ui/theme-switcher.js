...
export default function ThemeSwitcher() {
    ...
    return _jsx("button", { onClick: () => setTheme(t => t === 'dark' ? 'light' : 'dark'), style: { padding: '6px 10px', borderRadius: '8px', background: 'transparent', border: '1px solid var(--border)' }, children: theme === 'dark' ? '🌙 Dark' : '☀️ Light' });
}
