...
export const withActiveJobDefaults = <T extends Omit<ActiveJob, "confidence"> & { confidence?: number }>(
  value: T
): ActiveJob => {
...
export type ActiveJobSource = z.infer<typeof ActiveJobSourceSchema>;
export type ActiveJobKind = z.infer<typeof ActiveJobKindSchema>;
